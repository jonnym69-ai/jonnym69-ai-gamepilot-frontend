...
test.describe('Cross-Browser Compatibility', () => {
  ...
  test.describe('Desktop Browsers', () => {
    test('should work on Chromium', async ({ page }) => {
      ...
      await expect(page.locator('text=Chromium Test Game')).toBeVisible()
    ...
    test('should work on Firefox', async ({ page }) => {
      ...
      // Verify game was added
      await expect(page.locator('text=Firefox Test Game')).toBeVisible()
      await expect(page.locator('text=Game added successfully')).toBeVisible()
    ...
    test('should work on Safari', async ({ page }) => {
      ...
      // Verify game was added
      await expect(page.locator('text=Safari Test Game')).toBeVisible()
      await expect(page.locator('text=Game added successfully')).toBeVisible()
    ...
    test('should work on Edge', async ({ page }) => {
      ...
      // Verify game was added
      await expect(page.locator('text=Edge Test Game')).toBeVisible()
      await expect(page.locator('text=Game added successfully')).toBeVisible()
  ...
  test.describe('Mobile Browsers', () => {
    test('should work on iPhone', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="mobile-game-grid"]')).toBeVisible()
      ...
      // Verify game was added
      await expect(page.locator('text=iPhone Test Game')).toBeVisible()
      await expect(page.locator('text=Game added successfully')).toBeVisible()
    })
    ...
    test('should work on iPad', async ({ page }) => {
      ...
      // Verify game was added
      await expect(page.locator('text=iPad Test Game')).toBeVisible()
      await expect(page.locator('text=Game added successfully')).toBeVisible()
    })
    ...
    test('should work on Android', async ({ page }) => {
      ...
      // Verify game was added
      await expect(page.locator('text=Android Test Game')).toBeVisible()
      await expect(page.locator('text=Game added successfully')).toBeVisible()
    })
  })
  ...
  test.describe('Browser-Specific Features', () => {
    ...
    test('should support Safari features', async ({ page }) => {
      await page.goto('http://localhost:3000')
    ...
    test('should support Edge features', async ({ page }) => {
      await page.goto('http://localhost:3000')
  ...
  test.describe('Performance Across Browsers', () => {
    test('should have consistent load times', async ({ page }) => {
    ...
    test('should have consistent rendering performance', async ({ page }) => {
      await page.goto('http://localhost:3000')
  ...
  test.describe('Accessibility Consistency', () => {
    test('should maintain accessibility across browsers', async ({ page }) => {
      ...
      expect(focusedElements.count()).toBeGreaterThan(0)
    ...
    test('should support screen readers', async ({ page }) => {
      ...
      expect(a11yResults.violations.length).toBeLessThan(10)
    ...
    test('should handle reduced motion preferences', async ({ page }) => {
      ...
      const reducedMotionStyles = await animations.evaluateAll(elements => {
        return elements.map(el => window.getComputedStyle(el as Element).animationDuration === '0s')
      })
      
      expect(reducedMotionStyles.length).toBeGreaterThan(0)
    })
  })
  ...
  test.describe('Error Handling', () => {
    ...
    test('should handle timeout errors consistently', async ({ page }) => {
      // Simulate timeout
...
test.describe('Cross-Browser Performance Metrics', () => {
  ...
  test('should track Core Web Vitals', async ({ page }) => {
    ...
    expect(vitals.largestContentfulPaint).toBeLessThan(2500) // LCP under 2.5s
    expect(vitals.firstContentfulPaint).toBeLessThan(1000) // FCP under 1s
    expect(vitals.firstPaint).toBeLessThan(500) // FCP under 500ms
  })
})
