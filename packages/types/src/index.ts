...
// Import canonical models for re-export (using relative paths)
...
export interface Game {
  ...
  moods: MoodId[] // Mood tags for recommendations and filtering
  userRating?: number
  globalRating?: number
...
export interface Mood {
  ...
  description: string
  intensity: number
  energy: string // Missing energy property
...
// ============================================================================
// DEPRECATION RE-EXPORTS (Phase 1: Safe Migration)
// ============================================================================
