...
exports.addMoodPersonaTables = addMoodPersonaTables;
exports.initializePersonaProfiles = initializePersonaProfiles;
const database_1 = require("../services/database");
/**
 * Migration to add comprehensive mood and persona tracking tables
 * for the adaptive mood-persona integration system
 */
async function addMoodPersonaTables() {
    try {
 ...
 */
async function initializePersonaProfiles() {
    try {
...
//# sourceMappingURL=addMoodPersonaTables.js.map