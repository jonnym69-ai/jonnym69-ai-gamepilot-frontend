...
export declare const MoodSchema: z.ZodObject<{
    ...
    name: string;
    color: string;
    timeOfDay: ("afternoon" | "morning" | "evening" | "night")[];
    energyLevel: number;
    socialPreference: "competitive" | "any" | "solo" | "coop";
...
export declare const PlatformSchema: z.ZodObject<{
    ...
    code: "steam" | "other" | "xbox" | "playstation" | "nintendo" | "epic" | "gog";
    id: string;
    name: string;
    isConnected: boolean;
...
export declare const EmotionalTagSchema: z.ZodObject<{
    ...
    name: string;
    color: string;
    category: "social" | "memory" | "feeling" | "occasion";
    isCustom: boolean;
    description?: string | undefined;
    icon?: string | undefined;
...
export declare const AchievementSchema: z.ZodObject<{
    ...
    title: string;
    gameId: string;
    platformCode: "steam" | "other" | "xbox" | "playstation" | "nintendo" | "epic" | "gog";
    description?: string | undefined;
    icon?: string | undefined;
...
export declare const PlayHistorySchema: z.ZodObject<{
    ...
    gameId: string;
    userId: string;
    sessionType: "social" | "achievement" | "main" | "break";
    startTime: Date;
    achievements?: {
        id: string;
        title: string;
...
export declare const IntegrationSchema: z.ZodObject<{
    ...
    type: "discord" | "youtube" | "twitch" | "spotify";
    platform: string;
    id: string;
    connected: boolean;
