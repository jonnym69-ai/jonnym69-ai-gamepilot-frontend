"use strict";
// GamePilot Gaming Genre Taxonomy
Object.defineProperty(exports, "__esModule", { value: true });
exports.getPopularGenres = exports.searchGenres = exports.getGenresByCategory = exports.getSubgenreById = exports.getGenreById = exports.ALL_GENRES = exports.INDIE_GENRES = exports.ESPORTS_GENRES = exports.RETRO_GENRES = exports.NICHE_GENRES = exports.HYBRID_GENRES = exports.CORE_GENRES = void 0;
// Core Genres
exports.CORE_GENRES = [
    {
        id: 'action',
...
const getGenreById = (id) => {
    return exports.ALL_GENRES.find(genre => genre.id === id);
};
exports.getGenreById = getGenreById;
const getSubgenreById = (genreId, subgenreId) => {
    const genre = (0, exports.getGenreById)(genreId);
...
const getGenresByCategory = (category) => {
    return exports.ALL_GENRES.filter(genre => genre.category === category);
};
exports.getGenresByCategory = getGenresByCategory;
const searchGenres = (query) => {
    const lowercaseQuery = query.toLowerCase();
    return exports.ALL_GENRES.filter(genre => genre.name.toLowerCase().includes(lowercaseQuery) ||
...
const getPopularGenres = () => {
    // Return most common genres based on typical gaming preferences
    return [
        (0, exports.getGenreById)('action'),
        (0, exports.getGenreById)('rpg'),
        (0, exports.getGenreById)('strategy'),
        (0, exports.getGenreById)('sports'),
        (0, exports.getGenreById)('puzzle')
    ].filter(Boolean);
};
exports.getPopularGenres = getPopularGenres;
