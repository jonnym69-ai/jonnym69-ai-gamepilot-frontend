...
exports.getSteamIntegration = getSteamIntegration;
exports.migrateLegacySteamIntegration = migrateLegacySteamIntegration;
exports.updateSteamTokens = updateSteamTokens;
exports.updateSteamStatus = updateSteamStatus;
exports.validateSteamIntegration = validateSteamIntegration;
 ...
 */
async function getSteamProfile(userId) {
 ...
 */
async function getSteamIntegration(userId, authData) {
    ...
    try {
        ...
        const canonicalIntegration = integrationAdapter_1.IntegrationAdapter.steamProfileToIntegration(steamProfile, userId, authData);
 ...
 */
function migrateLegacySteamIntegration(legacyProfile, userId, additionalData) {
    ...
    const canonicalIntegration = integrationAdapter_1.IntegrationAdapter.steamProfileToIntegration(legacyProfile, userId, additionalData);
 ...
 */
function updateSteamTokens(integration, tokenData) {
 ...
 */
function updateSteamStatus(integration, status, errorCount) {
 ...
 */
function validateSteamIntegration(integration) {
