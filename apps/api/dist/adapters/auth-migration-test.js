...
exports.AuthMigrationTest = void 0;
exports.validateAuthMigration = validateAuthMigration;
...
class AuthMigrationTest {
    ...
    static async testRegistration() {
        ...
        try {
            ...
            const result = await (0, authService_1.register)(registerData);
            if (result.success && result.user) {
                ...
                const canonicalUser = userAdapter_1.UserAdapter.authUserToCanonical(result.user, {
    ...
    static async testLogin() {
        ...
        try {
            ...
            const result = await (0, authService_1.login)(loginData);
            if (result.success && result.user) {
    ...
    static testUserAdapter() {
        ...
        try {
            ...
            const mockCanonicalUser = userAdapter_1.UserAdapter.authUserToCanonical({
                id: 'test-123',
                username: 'testuser',
                email: 'test@example.com'
            }, {
            ...
            const authUser = userAdapter_1.UserAdapter.canonicalToAuthUser(mockCanonicalUser);
            console.log('✅ Converted to AuthUser');
            console.log('   AuthUser:', authUser);
            // Test validation
            const validation = userAdapter_1.UserAdapter.validateForAuth(mockCanonicalUser);
            console.log('✅ Validation result:', validation);
            // Test onboarding status
            const onboardingStatus = userAdapter_1.UserAdapter.hasCompletedOnboarding(mockCanonicalUser);
            console.log('✅ Onboarding status:', onboardingStatus);
            // Test auth status
            const authStatus = userAdapter_1.UserAdapter.getAuthStatus(mockCanonicalUser);
...
exports.AuthMigrationTest = AuthMigrationTest;
/**
