...
exports.getDiscordProfile = getDiscordProfile;
exports.getDiscordIntegration = getDiscordIntegration;
exports.migrateLegacyDiscordIntegration = migrateLegacyDiscordIntegration;
exports.updateDiscordTokens = updateDiscordTokens;
exports.updateDiscordStatus = updateDiscordStatus;
exports.validateDiscordIntegration = validateDiscordIntegration;
exports.getDiscordGuilds = getDiscordGuilds;
exports.getDiscordActivity = getDiscordActivity;
 ...
 */
async function getDiscordIntegration(userId, authData) {
    ...
    try {
        ...
        const canonicalIntegration = integrationAdapter_1.IntegrationAdapter.fromConnectionData('discord', userId, discordProfile.id, discordProfile.username, authData || {});
 ...
 */
function migrateLegacyDiscordIntegration(legacyProfile, userId, additionalData) {
    ...
    const canonicalIntegration = integrationAdapter_1.IntegrationAdapter.fromConnectionData('discord', userId, legacyProfile.id, legacyProfile.username, additionalData || {});
    // Add Discord-specific metadata
    canonicalIntegration.metadata.discord = {
        id: legacyProfile.id,
 ...
 */
function updateDiscordTokens(integration, tokenData) {
 ...
 */
function updateDiscordStatus(integration, status, errorCount) {
 ...
 */
function validateDiscordIntegration(integration) {
 ...
 */
async function getDiscordGuilds(userId) {
 ...
 * Uses canonical UserIntegration model for user context
 */
async function getDiscordActivity(userId) {
