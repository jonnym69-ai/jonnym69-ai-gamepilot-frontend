...
// Core Genres
export const CORE_GENRES: GenreDefinition[] = [
  {
    id: 'action',
    name: 'Action',
...
// Hybrid Genres
export const HYBRID_GENRES: GenreDefinition[] = [
  {
    id: 'action-adventure',
...
// Niche Genres
export const NICHE_GENRES: GenreDefinition[] = [
  {
    id: 'educational',
    name: 'Educational',
...
// Retro Genres
export const RETRO_GENRES: GenreDefinition[] = [
  {
    id: 'arcade-classics',
...
// Esports Genres
export const ESPORTS_GENRES: GenreDefinition[] = [
  {
...
export const INDIE_GENRES: GenreDefinition[] = [
  {
    id: 'experimental',
    name: 'Experimental',
...
export const getGenreById = (id: string): GenreDefinition | undefined => {
  return ALL_GENRES.find(genre => genre.id === id)
}

export const getSubgenreById = (genreId: string, subgenreId: string): SubgenreDefinition | undefined => {
  const genre = getGenreById(genreId)
  return genre?.subgenres.find(subgenre => subgenre.id === subgenreId)
}

export const getGenresByCategory = (category: GenreDefinition['category']): GenreDefinition[] => {
  return ALL_GENRES.filter(genre => genre.category === category)
}

export const searchGenres = (query: string): GenreDefinition[] => {
...
export const getPopularGenres = (): GenreDefinition[] => {
