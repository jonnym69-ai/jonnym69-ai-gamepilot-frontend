...
Remember: You have control over your data. Take time to review your settings and make choices that work for you.
      `,category:"privacy",tags:["security","privacy","data-protection"],relatedTopics:["profile-setup","integrations"]}],y=[{id:"all",name:"All Topics",icon:"📚"},{id:"basics",name:"Basics",icon:"🎯"},{id:"profile",name:"Profile",icon:"👤"},{id:"features",name:"Features",icon:"⚡"},{id:"library",name:"Library",icon:"🎮"},{id:"integrations",name:"Integrations",icon:"🔗"},{id:"privacy",name:"Privacy",icon:"🔒"}],d=m.filter(t=>{const a=t.title.toLowerCase().includes(i.toLowerCase())||t.description.toLowerCase().includes(i.toLowerCase())||t.tags.some(s=>s.toLowerCase().includes(i.toLowerCase())),o=n==="all"||t.category===n;return a&&o}),u=t=>{p(a=>{const o=new Set(a);return o.has(t)?o.delete(t):o.add(t),o})},h=t=>t.split(`
`).map((a,o)=>{if(a.startsWith("# "))return e.jsx("h2",{className:"text-2xl font-bold text-white mb-4 mt-6",children:a.slice(2)},o);if(a.startsWith("## "))return e.jsx("h3",{className:"text-xl font-semibold text-white mb-3 mt-4",children:a.slice(3)},o);if(a.startsWith("### "))return e.jsx("h4",{className:"text-lg font-medium text-white mb-2 mt-3",children:a.slice(4)},o);if(a.startsWith("- **")){const s=a.match(/- \*\*(.*?)\*\*: (.*)/);if(s)return e.jsxs("li",{className:"ml-4 mb-2",children:[e.jsxs("span",{className:"font-semibold text-purple-300",children:[s[1],":"]})," ",s[2]]},o)}else return a.startsWith("- ")?e.jsx("li",{className:"ml-4 mb-2",children:a.slice(2)},o):a.startsWith("**")&&a.endsWith("**")?e.jsx("p",{className:"font-semibold text-purple-300 mb-2",children:a.slice(2,-2)},o):a.trim()===""?e.jsx("br",{},o):e.jsx("p",{className:"mb-2 text-white/80",children:a},o)});return e.jsx("div",{className:"min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6",children:e.jsxs("div",{className:"max-w-6xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-8",children:[e.jsx("h1",{className:"text-4xl font-bold text-white mb-4",children:"Help Center"}),e.jsx("p",{className:"text-white/70",children:"Find answers to your questions and learn how to get the most out of GamePilot"})]}),e.jsx("div",{className:"mb-8",children:e.jsxs("div",{className:"bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6",children:[e.jsx("div",{className:"mb-4",children:e.jsx("input",{type:"text",placeholder:"Search for help topics...",value:i,onChange:t=>r(t.target.value),className:"w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-white/40"})}),e.jsx("div",{className:"flex flex-wrap gap-2",children:y.map(t=>e.jsxs("button",{onClick:()=>g(t.id),className:`px-4 py-2 rounded-lg border transition-colors ${n===t.id?"bg-purple-500/20 border-purple-500 text-purple-300":"bg-white/10 border-white/20 text-white/70 hover:bg-white/20"}`,children:[e.jsx("span",{className:"mr-2",children:t.icon}),t.name]},t.id))})]})}),e.jsx("div",{className:"space-y-4",children:d.map(t=>e.jsxs(f,{className:"bg-white/10 backdrop-blur-md border-white/20 p-6",children:[e.jsxs("div",{className:"cursor-pointer",onClick:()=>u(t.id),children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("h3",{className:"text-xl font-semibold text-white",children:t.title}),e.jsx("span",{className:"text-white/60",children:l.has(t.id)?"▼":"▶"})]}),e.jsx("p",{className:"text-white/70 mb-3",children:t.description}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-3",children:t.tags.map(a=>e.jsx("span",{className:"px-2 py-1 bg-purple-500/20 text-purple-300 rounded-full text-sm",children:a},a))})]}),l.has(t.id)&&e.jsxs("div",{className:"mt-4 pt-4 border-t border-white/20",children:[e.jsx("div",{className:"prose prose-invert max-w-none",children:h(t.content)}),t.relatedTopics&&t.relatedTopics.length>0&&e.jsxs("div",{className:"mt-6 pt-4 border-t border-white/20",children:[e.jsx("h4",{className:"text-lg font-medium text-white mb-3",children:"Related Topics"}),e.jsx("div",{className:"flex flex-wrap gap-2",children:t.relatedTopics.map(a=>{const o=m.find(s=>s.id===a);return o?e.jsx("button",{onClick:()=>u(a),className:"px-3 py-1 bg-blue-500/20 text-blue-300 rounded-lg hover:bg-blue-500/30 transition-colors",children:o.title},a):null})})]})]})]},t.id))}),d.length===0&&e.jsxs("div",{className:"text-center py-12",children:[e.jsx("div",{className:"text-6xl mb-4",children:"🔍"}),e.jsx("h3",{className:"text-xl font-semibold text-white mb-2",children:"No topics found"}),e.jsx("p",{className:"text-white/70",children:"Try adjusting your search or filters"})]})]})})};export{b as default};
